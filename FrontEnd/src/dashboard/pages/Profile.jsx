  ...
  return (
    <div className='w-full grid grid-cols-2 gap-x-6 mt-5'>
      <div className='bg-white gap-x-3 p-6 rounded flex justify-center items-center'>
        <div>
          <label htmlFor='img' className={`w-[150px] h-[150px] flex rounded text-[#404040]
        ...
        <div className='text-[#404040] flex flex-col gap-y-1 justify-center items-start'>
          <span>Name : Rayhan Ahmed</span>
          <span>Email : rayhan3051@gmail.com</span>
      ...
      <div className='bg-white px-6 py-4 text-[#404040]'>
        ...
        <div className='flex flex-col gap-y-2'>
              ...
              <input type='password' placeholder='old password' name='old_password' className='px-3 py-2 rounded-md outline-0 border
         border-gray-300 focus:border-green-500 h-10' id='pld_password'/>
            </div>
            <div className='flex flex-col gap-y-2'>
              <label className='text-md font-medium text-gray-600' htmlFor='new_password'>New Password</label>
              <input type='password' placeholder='new password' name='new_password' className='px-3 py-2 rounded-md outline-0 border
         border-gray-300 focus:border-green-500 h-10' id='new_password'/>
            </div>
          </div>
          <div className='mt-4'>
          <button className='px-3 py-[6px] bg-black rounded-sm text-white
           hover:bg-black'>Change Password</button>
          </div>
        </form>
      </div>
    </div>
