    ...
    <div className='bg-white rounded-md'>
      <div className='flex justify-between p-4'>
        ...
        <Link className='px-3 py-[6px] bg-black rounded-sm text-white hover:bg-black' 
          to='/dashboard/writers'>Writers</Link>
      </div>
      <div className='p-4'>
        <form>
          <div className='grid grid-cols-2 gap-x-8 mb-3'>
            <div className='flex flex-col gap-y-2'>
              ...
              <input type='text' placeholder='name' name='name' className='px-3 py-2 rounded-md outline-0 border
         border-gray-300 focus:border-green-500 h-10' id='name'/>
            </div>
            <div className='flex flex-col gap-y-2'>
         ...
         border-gray-300 focus:border-green-500 h-10'>
          ...
          <div className='grid grid-cols-2 gap-x-8 mb-3'>
            <div className='flex flex-col gap-y-2'>
              ...
              <input type='email' placeholder='email' name='email' className='px-3 py-2 rounded-md outline-0 border
         border-gray-300 focus:border-green-500 h-10' id='email'/>
            ...
            <div className='flex flex-col gap-y-2'>
              ...
              <input type='password' placeholder='password' name='password' className='px-3 py-2 rounded-md outline-0 border
         border-gray-300 focus:border-green-500 h-10' id='password'/>
            </div>
          </div>
          <div className='mt-4'>
          <button className='px-3 py-[6px] bg-black rounded-sm text-white
           hover:bg-black'>Add Writer</button>
          </div>
        </form>
      </div>
    </div>
