  ...
  return (
    ...
    <div className='flex justify-between p-4'>
      ...
      <Link className='px-3 py-[6px] bg-black rounded-sm text-white hover:bg-black' 
        to='/dashboard/news'>News</Link>
    </div>
    <div className='p-4'>
    <form>
            <div className='flex flex-col gap-y-2 mb-6'>
                  <label className='text-md font-medium text-gray-600' htmlFor='title'>Title</label>
                <input type='text' placeholder='title' name='title' className='px-3 py-2 rounded-md outline-0 border
              border-gray-300 focus:border-green-500 h-10' id='title'/>
            </div>
            <div className='mb-6'>
              <div>
                  <label htmlFor='img' className={`w-full h-[180px] flex rounded text-[#404040]
          ...
          <button className='px-3 py-[6px] bg-black rounded-sm text-white
           hover:bg-black'>Add News</button>
          </div>
    </form>
    </div>
    {
